...
<body>
    <div id="app">
        ...
        <div align="center">
            ...
            <div id="page1" class="page active" data-index="1">
                <h1>create your own card<br>オリジナルカードを作ろう</h1>
            ...
            <from id="save-db" action="" name="outbraingame" method="post">
                ...
                <div id="page2" class="page" data-index="3">
                    ...
                    <h1 data-translate="permissionPhoto"></h1>
                ...
                <div id="page5" class="page" data-index="6">
                    <h1 data-translate="gender">Select Your Gender</h1>
                ...
                <div id="page6" class="page" data-index="7">
                    ...
                    <button id="Q3A4" data-translate="Q3A4" data-answer="staying in the bedroom"></button>
                </div>

                <!-- Page 7: Q4 Something you are good at -->
                <div id="page7" class="page" data-index="8">
                    <h1 data-translate="Q4Prompt"></h1>
                    <input type="text" id="Q4Prompt" maxlength="25" required>
                ...
                <div id="page9" class="page" data-index="10">
                    <h1 data-translate="Q6Prompt"></h1>
                    <input type="text" id="Q6Prompt" maxlength="25" required>
                    <button id="next" data-translate="next" class="next-button position-bottom">Next</button>
                </div>

                <!-- Page 10: Q7 What do you like about yourself -->
                <div id="page10" class="page" data-index="11">
                    <h1 data-translate="Q7Prompt"></h1>
                ...
                <div id="page13" class="page" data-index="13">
                    <h1 data-translate="Q10Prompt"></h1>
                ...
                <div id="lastQ" class="page" data-index="14">
                    <h1 data-translate="lastQPrompt"></h1>
                    <input type="text" id="interest" maxlength="25" required>
                    <button id="submit" data-translate="submit">Submit</button>
                </div>
            ...
            <div id="pageLoading" class="page" data-index="15">
                <h1 data-translate="generating">Generating your personalized card...</h1>
    ...
    <script src="app.js?ver=1.0.0"></script>
    <script src="keyboard.js?ver=1.0.0"></script>
